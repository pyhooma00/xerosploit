...
""")
	...
	if system0 == "1":
		...
		install = os.system("apt-get update && apt-get upgrade -y && apt-get install -y nmap hping3 build-essential python3-pip ruby-dev git libpcap-dev libgmp3-dev && pip3 install tabulate terminaltables")
		...
		install = os.system("apt-get update && apt-get upgrade -y && apt-get install -y nmap hping3 ruby-dev git libpcap-dev libgmp3-dev python3-tabulate python3-terminaltables")
